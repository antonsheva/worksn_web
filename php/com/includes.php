...
include 'www/php/classes/ClassImg.php';
include 'www/php/classes/ClassLog.php';
include 'www/php/classes/ClassPost.php';
...
include 'www/php/classes/ClassAds.php';
...
include 'www/php/structures/StructUser.php';
include 'www/php/structures/StructUserShort.php';
include 'www/php/structures/StructAds.php';
...
include 'www/php/structures/AssocData.php';
include 'www/php/structures/SaveImgData.php';

include 'www/php/structures/dbStruct/tblAds.php';
...
include 'www/view/frames/frmLoginForm.php';
include 'www/view/frames/userMenu.php';
include 'www/view/frames/chngPass.php';
include 'www/view/frames/regForm.php';
include 'www/view/frames/updtUserData.php';
include 'www/view/frames/updtAutoAuthData.php';
include 'www/view/frames/recoveryPass.php';
include 'www/view/frames/addAdsForm.php';
include 'www/view/frames/ratingStars.php';
include 'www/view/frames/frmAdsParameter.php';
include 'www/view/frames/frmSendMsgForm.php';
...
include 'www/view/frames/frmReplyToMsgForm.php';
